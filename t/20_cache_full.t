...
print "1..0\n"; # cache/defer don't work in FixedRecLen
exit;
...
my $o = tie @a, 'Tie::File::FixedRecLen', $file, record_length => 20, pad_char => '.', memory => $MAX, autodefer => 0;
print $o ? "ok $N\n" : "not ok $N\n";
$N++;
...
# It should now contain only the *last* three records, 7, 8, and 9
{
  ...
  print "ok $N # skipped - FixedRecLen is not bothered too much about the cache just yet\n";
